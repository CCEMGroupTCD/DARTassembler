...
with patch('stk.SmartsFunctionalGroupFactory', new=MONKEYPATCH_STK_SmartsFunctionalGroupFactory):
    ...
    if __name__ == "__main__":
        ...
        # Monkeypatch stk
        # from  import _get_atom_ids


        # stk.molecular.functional_groups.factories.utilities._get_atom_ids = MONKEYPATCH_stk_get_atom_ids
        # sys.modules["stk.molecular.functional_groups.factories.utilities"]._get_atom_ids = MONKEYPATCH_stk_get_atom_ids
        # stk.molecular.functional_groups.factories.utilities_get_atom_ids = MONKEYPATCH_stk_get_atom_ids
