...
if __name__ == "__main__":
    ...
    ligand_filter_path = project_path().extend('/Users/cianclarke/Documents/PhD/Complex_Assembly/DART/src05_Assembly_Refactor/Manting_NN_ligands.yml')  # this must be: "ligand_filter_path = project_path().extend('src05_Assembly_Refactor', 'ligandfilters.yml')" to run benchmark
    max_number = 7692384437893643408933893 # this must be 5000 for the benchmark
