...
This is the documentation for the chemistry software **DART** (Directed Assembly of Random Transition metal complexes), developed by the CCEM group at Trinity College Dublin. This guide aims to provide all the information you need to get started with DART, whether you are a computational chemist, experimental researcher, or software developer.
