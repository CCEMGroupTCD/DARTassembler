...
#   - add properties
#       - molecules: n_atoms
#       - complexes: n_isolated_unique_ligands (number of unique ligands which occur only once)
#       - unique_ligand: chosen_denticity_fraction (the fraction of the occurrences of the chosen denticity over all denticities)
#   - change_properties:
