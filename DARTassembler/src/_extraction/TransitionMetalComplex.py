...
if __name__ == '__main__':
    ...
    # new_complex_path = '/Users/timosommer/PhD/projects/RCA/projects/DART/tests/pytest/assembly/data_output/batches/Integration_test_1/complexes/AZEPOBOB/AZEPOBOB_data.json'
