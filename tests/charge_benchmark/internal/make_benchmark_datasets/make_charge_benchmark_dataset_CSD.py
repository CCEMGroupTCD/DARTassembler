...
if __name__ == '__main__':
    ...
    save_csvs_dir = '../databases/charge_benchmark/CSD_ligands_to_benchmark'
    ...
    for c_id, c in tqdm(all_complexes.items(), desc='Build full ligand db'):
        ...
        for lig in c['ligands']:
            ...
            all_ligands.append({
                                ...
                                'n_ligand_instances': sum([lig['unique_name'] == lig2['unique_name'] for lig2 in c['ligands']]),
                                'connected': lig['n_donors'] > 0,
                                'charge': np.nan,
                                'n_donors': np.nan,
