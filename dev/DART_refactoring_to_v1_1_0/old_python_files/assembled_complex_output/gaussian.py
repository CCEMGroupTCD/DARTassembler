...
class GaussianOutput(object):
    ...
    def __init__(self, input_path: Union[str, Path]):
        ...
        self.elements = [Element(Z).symbol for Z in self.parser.atomnos]
    ...
    def get_gaussian_relaxed_complex(self, data_json: Union[str, Path] = None) -> TransitionMetalComplex:
        ...
        elements = [Element(Z).symbol for Z in self.parser.atomnos]
    ...
    def get_metal_charge(self, method='mulliken'):
        ...
        try:
            if method in self.parser.atomcharges:
                ...
                metal_index = [idx for idx, Z in enumerate(atom_numbers) if Element(Z).is_transition_metal]
