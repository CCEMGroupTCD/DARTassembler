...
if __name__ == "__main__":
    ...
    assembled_complexes_dir = '/Users/timosommer/PhD/projects/RCA/projects/DART/dev/oerdata/testbatch_data/output/assembler_test_100_complexes'

    method = 'GFN2-xTB'
    force_criterion = 1e-2  # lower is more accurate
    verbosity = 0
