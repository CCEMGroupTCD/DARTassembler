...
class Window2(QMainWindow):  # This window corresponds to the Create Batch window
    def setupUi(self, Batch_Widget):  # Here we set up the widget
        ...
        self.comboBox_2.setItemText(11, _translate("Batch_Widget", "Pt"))
        self.comboBox_2.setItemText(12, _translate("Batch_Widget", "Pd"))
        self.comboBox_2.setItemText(13, _translate("Batch_Widget", "Ir"))
        self.comboBox_2.setItemText(14, _translate("Batch_Widget", "Ru"))
    ...
    def close_assembly_widget(self):  # This function closes the widget
        if (self.spinBox.text() != "MAX. Complex") and self.tableView_2.count() and self.tableWidget.rowCount() and (str(self.comboBox_isomer.currentText()) != "Isomers") and (self.spinBox_2.text() != "Random Seed"):
            self.tmp_Dic.clear()
...
class Window(QtWidgets.QMainWindow):
    ...
    def main_window(self, MainWindow):
        ...
        self.VersionLabel.setText(_translate("MainWindow", "V 0.6.0"))
...
class ThreadClass(QtCore.QThread):
    ...
    def run(self):
        ...
        Assembly_instance = Assembly(list_of_batches=[{'Name': 'first test batch',
                                                       "Input_Path": "/Users/cianclarke/Documents/PhD/Complex_Assembly/CreateTMC/data/Filtered_Jsons/filteredLigDB_Max_Demo.json",
                                                       ...
                                                       "Random_Seed": "12"}])
                                                        # random seed 12 was used for the 0 and +1 file 638856 was used for the +2 file
