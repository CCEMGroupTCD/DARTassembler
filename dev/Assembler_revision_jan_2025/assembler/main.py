...
from utilities import BatchInput, Isomer
...
if __name__ == "__main__":
    ...
    for batch in yaml_dict["batches"]:
        ...
        ligand_db_list = [ligand.ligand_db._get_lig_db_in_old_format() for ligand in assembly_input.ligands]
        ...
        for idx, ligand_combination in enumerate(ligand_combinations):
            ChemBuild = Isomer(ligands=ligand_combination,
