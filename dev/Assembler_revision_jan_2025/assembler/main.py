...
if __name__ == "__main__":
    ...
    for batch in yaml_dict["batches"]:
        ...
        for ligand in assembly_input.ligands:
            ligand_db = LigandDB.load_from_json(path=ligand.ligand_db)
            ligand["ligand_db"] = ligand_db


        # Based on charge compatability we should then choose ligands for the assembly


        # We should align the donor atoms and assemble the final complex
